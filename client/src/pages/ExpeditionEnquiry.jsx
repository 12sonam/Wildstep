    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[60vh] bg-gray-900">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1516302350523-4c29d47b89e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=2340&q=80)',
...
export default ExpeditionEnquiry; 